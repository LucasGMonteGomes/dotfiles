...
-- Folding estrutural para Java, Rust e demais linguagens com Treesitter.
-- Os arquivos continuam abertos por padrao; use za, zM e zR sob demanda.
vim.opt.foldmethod = "expr"
vim.opt.foldexpr = "v:lua.vim.treesitter.foldexpr()"
vim.opt.foldenable = false
vim.opt.foldlevel = 99
-- Usado por interfaces graficas; no terminal, a fonte e definida pelo emulador.
...
local yaml_indent_group = vim.api.nvim_create_augroup("YamlIndent", {
  clear = true,
})

vim.api.nvim_create_autocmd("FileType", {
  group = yaml_indent_group,
  pattern = {
    "yaml",
    "yaml.*",
  },
